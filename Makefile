...
#COMAKE UUID
COMAKE_MD5=6cb2eddfb3f5eed41152031216235cea  COMAKE
...
libsimilarity.a:similarity_dictionary.o \
  ...
  similarity_repo.o
	...
	cp -f --link dictionary.h document.h token.h segment.h encoding.h corpus.h model.h concurrent.h ./output/include

train:train_main.o \
  -lsimilarity
	@echo "[[1;32;40mCOMAKE:BUILD[0m][Target:'[1;32;40mtrain[0m']"
	$(CXX) train_main.o -Xlinker "-(" -lsimilarity ../../../../../../app/mobile/flyflow/server/lib/common/libcommon.a \
...
sim:sim_sim_main.o \
  -lsimilarity
	...
	$(CXX) sim_sim_main.o -Xlinker "-(" -lsimilarity ../../../../../../app/mobile/flyflow/server/lib/common/libcommon.a \
  ../../../../../../app/mobile/flyflow/server/lib/libenca/output/lib/libenca.a \
  ../../../../../../app/mobile/flyflow/server/lib/storage/lib/libkvstorage.a \
  ../../../../../../app/mobile/flyflow/server/lib/storage/lib/libredisstorage.a \
  ../../../../../../app/search/ksarch/store/libmemcached/lib/libhashkit.a \
